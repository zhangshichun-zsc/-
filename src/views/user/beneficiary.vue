  ...
  <div class='bene'>
    <div class="integral-header">
      ...
      <div class="integral-body">
        <div class="flex-center-start" style="margin-bottom: 0.5rem">
          ...
          <div class="flex-center-start">
            <span>家长小组:</span>
            <Input size="large" placeholder="家长小组" class="inpt" />
          </div>
          <div class="flex-center-start">
            <span>注册时间:</span>
    ...
    <div class="integral-table">
      <div class="table-header flex-center-between">
        ...
        <div>
          <!--修改vip时间-->
          <Modal v-model="modal5" title="修改vip时间" @on-ok="ok" @on-cancel="cancel">
            <Form ref="formValidate4" :model="formValidate4" :rules="ruleValidate4" :label-width="180">
              <FormItem label="调整到期时间：" prop="AdjustedExpirationTime">
                <RadioGroup v-model="formValidate4.IncreaseDecrease" vertical>
                  <div class="flex-center-start">
                    <Radio label="increase">
                      <span>增加</span>
                    </Radio>
              ...
              <FormItem label="备注信息：">
                <Input v-model="formValidate1.NoteInformation" type="textarea" :autosize="{minRows: 5,maxRows: 8}"></Input>
              </FormItem>
            </Form>
          </Modal>
          <Dropdown>
...
export default {
  data() {
    return {
      ...
      formValidate4: {
        IncreaseDecrease: 'increase' //修改vip时间(默认增加)
      },
      ruleValidate4: {
