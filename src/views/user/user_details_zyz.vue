    ...
    export default {
      data () {
        return {
          ...
          data4: [
            {
              ActivityName: '5.12 徒步在夏日 游园活动',
              ActivityTime: '2019-05-12 10:00:00',
            ...
            {
              ActivityName: '2.12 喜迎元宵 爱暖敬老院',
              ActivityTime: '2019-02-12 8:00:00',
              UserAccount: '18000000000',
              ParticipateType: '志愿者',
              ActivityType: '敬老',
              state: '已参与',
      ...
      methods: {
        Editor(){
          this.$router.push({ name: 'Edit_data_zyz' })
        },
        Log(){
          this.$router.push({ name: 'Login_zyz' })
        },
        jump(){
