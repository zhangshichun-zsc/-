            ...
            >
              ...
              <FormItem label="短信内容：" prop="Message">
                ...
                <p style="font-size: 12px;">
                  内容上限不能超过<span class="red">500</span
                  >字，当前已输入<span class="red">3</span>字，将作为<span
                    class="red"
                    >1</span
                  >条发送
                </p>
          ...
          <Col span="12">
            <FormItem label="" class="formitem">
              ...
              <Input
                type="text"
                style="width:200px"
                v-model="paramsSeniorObj.account"
              ></Input>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem label="">
              ...
              <Input
                type="text"
                style="width:200px"
                v-model="paramsSeniorObj.nickname"
              ></Input>
            </FormItem>
          </Col>
        </Row>
            ...
            <FormItem label="" class="formitem">
              ...
              <Col span="12">
                <DatePicker
                  type="date"
                  placeholder="请选择开始时间"
                  v-model="registrationStartTimeStamp"
                  style="width: 200px;"
                ></DatePicker>
              </Col>
            </FormItem>
          ...
          <Col span="12">
            <FormItem label="" class="formitem">
              ...
              <DatePicker
                type="date"
                placeholder="请选择结束时间"
                v-model="registrationEndTimeStamp"
                style="width: 200px"
              ></DatePicker>
            </FormItem>
          </Col>
