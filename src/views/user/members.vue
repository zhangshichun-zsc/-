  ...
  <div class="spread">
    <div class="integral-header">
      ...
      <div class="flex-center-start integral-body">
        ...
        <div class="flex-center-start">
          <span>机构名称:</span>
          <Input size="large" placeholder="机构名称"  class="inpt"/>
        </div>
        <div class="flex-center-start">
          <span>注册时间:</span>
          ...
          <Modal
            ...
            <Form ref="formValidate2" :model="formValidate2" :rules="ruleValidate2" :label-width="120">
              ...
              <FormItem label="标题" prop="title">
                <Input v-model="formValidate2.title" />
              </FormItem>
              <FormItem label="内容：" prop="content">
                <Input v-model="formValidate2.content" type="textarea" :autosize="{minRows: 5,maxRows: 8}"/>
              ...
              <Modal
                ...
                <Form ref="formValidate3" :model="formValidate3" :rules="ruleValidate3" :label-width="120">
                  ...
                  <FormItem label="推送链接" prop="PushLink">
                    <Input v-model="formValidate3.PushLink"/>
                  </FormItem>
