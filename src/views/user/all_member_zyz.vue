  ...
  <div class="member">
    <div class="integral-header">
      ...
      <div class="flex-center-start integral-body">
        ...
        <div class="flex-center-start">
          <span>组织名称:</span>
          <Input size="large" placeholder="组织名称"  class="inpt"/>
        </div>
        <div class="flex-center-start">
          <span>注册时间:</span>
    ...
    <div class="integral-table">
      <div class="table-header flex-center-between">
        ...
        <div>
          <Button class="table-btn">显示条数<Icon type="md-arrow-dropdown" /></Button>
          <Button class="table-btn">排序方式<Icon type="md-arrow-dropdown" /></Button>
...
export default {
          ...
          render: (h, params) => {
            return h('div', [
              h('span', {
                ...
                on: {
                  click: () => {
                    this.$router.push({name:'user_details_zyz'})
                  }
                }
              }, '查看'),
              h('span', {
  ...
  methods: {
    ...
    jump2(){
      this.$router.push({ name: 'TagList_zyz' })
    }
  }
}
