  ...
  <div>
    ...
    <div class="main">
      ...
      <div class="content">
        <Row>
          <Col span="12">
          <div class='content-item' v-if='parameOBJ.basicInfo'>
            <div class="con-box bk item">
              ...
              <Form :label-width="120" style="padding: 0.5rem" label-position='left'>
                ...
                <FormItem label="身份证件类型" v-show="basic.idCard">
                ...
                <FormItem prop="address" label="详细地址" v-show="basic.createAt">
          ...
          <Col span="12">
          <div class='content-item' v-if='parameOBJ.volInfo'>
            <!-- 志愿者信息 -->
            <div class="con-box bk item">
              <div class="constant-title flex-center-between">
                <span>
...
export default {
  data() {
    return {
      ...
      cityList1: [{ value: 'option1', label: '男' }, { value: 'option2', label: '女' }],
      formInline2: {
