...
<p class="yi">1.本说明下的活动发布规则主要指融爱融乐的工作人员或者家长小组在本系统发布融合活动所应遵守的内容和条款。</p>
<p class="yi">2.家长小组是由心智障碍家庭家长自发组成的互助小组。小组旨在通过培养核心家长，发挥家长的组织领导和社会倡导力，成为行动者，以此改善社区及社会对心智障碍人士的认知。</p>
<p class="yi">3.您必须是成功在本系统成功注册的家长小组或其他系统授予发布活动权限的会员。您需要按活动立项页面的引导填写信息，包括但不限于立项名称、立项目的、小组归属、招募类型、活动申请预算、有效期限，阅读并同意《活动发布规则》且完成全部立项程序，经本系统审核通过后方能发布信息。</p>
<p class="yi">4.审核的时间通常为5个工作日。但本系统有权根据特殊情况对审核时间进行调整。</p>
<p class="yi">5.您特此保证，您发布的任何信息，不存在以下任何一种违反法律法规规定的情形：</p>
<p class="er">1)反对宪法所确定的基本原则；</p>
<p class="er">2)危害国家安全，泄露国家秘密，颠覆国家政权，破坏国家统一；</p>
...
<p  class="yi">6.您特此保证，您发布的任何信息，不存在以下任一不友善的行为：</p>
<p class="er">1)捏造、散布虚假事实，损害他人名誉；</p>
<p class="er">2)以不友好的方式激怒他人，意图使对方对自己的言论作出回应，蓄意制造事端；</p>
<p class="er">3)贬低他人的能力、行为、生理或身份特征，让对方难堪；</p>
<p class="er">4)以不文明的语言对他人进行负面评价；</p>
<p class="er">5)针对他人的民族、种族、宗教、性取向、性别、年龄、地域、生理特征等身份或者归类的攻击；</p>
<p class="er">6)许诺以不良的后果来迫使他人服从自己的意志。</p>
<p class="yi">7.您特此保证，您发布的任何信息，不存在以下任一侵犯第三方权益的情形：</p>
<p class="er">1)任何侵害他人名誉权、肖像权、知识产权、商业秘密等合法权利的内容；</p>
<p class="er">2)任何涉及他人隐私、个人信息或资料的内容；</p>
<p class="er">3)任何混淆行为，擅自使用包括但不限于社会组织名称（包括简称等）、企业名称（包括简称、字号等）、姓名（保留笔名、艺名、译名等）、域名主体部分、网站名称、网页等引人误认为是他人单位与他人存在特定联系的内容。</p>
<p>8.您在发布信息时还应遵守以下条款：</p>
<p class="er">1)保证不发布与本平台志愿服务目的无关之信息；</p>
<p class="er">2)保证所发布的全部信息均为真实、有效的，没有任何虚假信息；</p>
<p class="er">3)保证不违反任何与您发布的信息相关的、与任何第三方（包括但不限于与投资者）之间的约定或承诺；</p>
<p class="er">4)保证不违反您所在机构或公司的规章制度。</p>
<p class="yi">9.您理解并同意，本系统仅为网络服务提供者，为您提供的是信息分享、传播及获取的平台，您必须为自己注册账户下的一切行为负责，包括您所发布的任何内容、活动及由此产生的任何后果。</p>
<p class="yi">10.您理解并同意，若您出现任何违反本规则及《会员服务协议》的行为的，本系统有权自行删除您发布的全部信息，无需另行事先通知，并有权采取冻结账户，要求您赔偿损失等措施。</p>
<p class="yi">11.本系统有权随时根据法律、法规的变化以及融爱融乐经营策略的调整等修改本规则。修改后的规则将会通过适当的方式将进行公示。如您在本规则后修订后仍继续使用本系统的，则视为您接收本规则的修订。</p>
       </div>
    </Modal>
