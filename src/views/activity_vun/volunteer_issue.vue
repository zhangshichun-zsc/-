    ...
    <div class="content">
              ...
              <ul>
                ...
                <li class="start">
                  ...
                  <div class="start-wap start-firt">
                    ...
                    ></UploadImg>
                    <!-- TODO  疑问： image !== null && !isDisb   isDisb ： true (不可编辑) false:  -->
                  </div>
                </li>
                <li class="start">
                  <span>活动图片</span>
            ...
            <div class="active-publish">
              <ul>
                <li class="flex-start">
                  <span>活动地址</span>
                  <div>
                    <Button @click="getAdr" class="adr" long>{{
      ...
      <Row class-name="row20">
        <i-col push="18" span="6">
          <div class="btns">
            <Button @click="sumbmit(8)" shape="circle" size="large" class="left"
              >存为草稿</Button
            >
            <Button
              @click="sumbmit(1)"
    ...
    getRelse(i) {
      ...
      getActiveRelse({ activityId: this.activityId }).then(res => {
        if (res.code == 200) {
          ...
          this.zhaStart =
            i == 4 ? null : res.data.enrollStarttime + ":00" || null;
          this.zhaEnd = i == 4 ? null : res.data.enrollEndtime + ":00" || null;
          this.args.enrollStarttime = this.zhaStart;
          this.args.enrollEndtime = this.zhaEnd;
