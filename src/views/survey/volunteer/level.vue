  ...
  <div>
    ...
    <div class="content">
      ...
      <div class="contentBox">
        ...
        <!-- <div class="rightBox">
          <span class="levelSet">积分规则设置</span>
        </div>-->
      </div>
...
export default {
  ...
  methods: {
    ...
    // 获取等级列表
    getLevelList() {
      queryLevelList({ typeFlag: 2 }).then(res => {
        console.log("res", res);
        if (res.code == 200) {
...
var surveyListNew = this.surveyList
for (let i in this.surveyList) {
  // if (this.surveyList[i].conditionS=="") {
  // // surveyListNew[i].condition = this.surveyList[i].condition
  // surveyListNew[i].conditionS = null
  // }
  // if (this.surveyList[i].levelName=="") {
  // // surveyListNew[i].condition = this.surveyList[i].condition
  // surveyListNew[i].levelName = null
  // }
  // if (this.surveyList[i].score=="") {
  // // surveyListNew[i].condition = this.surveyList[i].condition
  // surveyListNew[i].score = null
  // }
      ...
      console.log("this.surveyListnewnewnewnew",this.surveyList)
