    ...
    <div class="content">
      <div class="con">
        ...
        <div class="add inter-table">
          <Form class="bd" ref="AddDate" :model="AddDate" :rules="ruleValidate" :label-width="120">
            <FormItem label="相册名称:" prop="AlbumName">
            ...
            <FormItem label="相册描述:">
              <Input style="width: 20rem" v-model="AddDate.AlbumDescription" type="textarea" :autosize="{minRows: 8,maxRows: 5}" placeholder="请输入内容"></Input>
            </FormItem>
            <FormItem label="排序:">
              <Input style="width: 10rem" v-model="AddDate.Sorting"></Input>
            </FormItem>
            <FormItem>
