...
<template>
  <div class="set">
    ...
    <div class="content">
      <div class="content-tit">志愿者积分</div>
      <div class="content-list">
        <ul class="list-left">
          <li v-for="(item,index) in data" :key="index">{{item.comments}}
            <div class="right-input flex-center-start">
              <span> <Icon type="md-remove" size='25' v-if="item.typeChange==2"/> <Icon type="ios-add-circle" size='25' v-if="item.typeChange==1"/>积分:</span>
