    ...
    <div class="integral-header">
      ...
      <div class="integral-right">
        ...
        <div class="bottom">
          ...
          <h5>图片最大为*</h5> -->
           <div class="box" v-show='i == 1'>
            ...
            <Icon type="ios-trash" v-if='!show && headimg != null' size='24' color="#FF565A"  class="cancel" @click="cancelImg('logoPic')"/>
        </div>
        <div class="box" v-show='i == 2'>
            ...
            <Icon type="ios-trash" v-if='!show && footimg != null' size='24' color="#FF565A" class="cancel" @click="cancelImg('officeSealPic')"/>
        </div>
