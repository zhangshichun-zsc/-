...
<template>
  <div>
    ...
    <div class="content" v-if="!isAddRole">
          <div class="select">
              ...
              <ul>
                ...
                <li class="imges">
                  ...
                  <div class="start-wap">
                    ...
                    <img class="imgs" v-else :src="batch.batchPicShow"/>
...
<script>
import { projectDetail,batchItem,leader,projectApproval,orgimgdel } from "@/request/api";
  ...
  data() {
    return {
      navigation1: {
        ...
        // 富文本editor
        editor1: {
          contents:'一. 培训内容 志愿者培训工作包括2个内容：理论知识培训，实践培训。'
      },
      batch:{
        userConfList:[],
        actResList:[],
