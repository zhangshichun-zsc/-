    ...
    <div class="content">
      ...
      <div class="con">
        ...
        <div class="con-right bk">
          ...
          <div>
            <div v-for="(item,index) in msg.detailList" :key='index'>
              <div class="ls-item" v-if=' index == 0 '>
                {{ item.detailText }}
              </div>
              <view class="ls-item flex-wrap-start" v-else-if=' index == 1'>
               ...
               <div class="ls-item"  v-else-if='~~item.typeFlag === 4'>
                ...
                <div class="item">
                    <CheckboxGroup v-model="item.value" vertical>
                      <Checkbox :label="substrs(i)"  v-for="(val,i) in item" :key='i' v-if='sign(val,i)' disabled ></Checkbox>
                  </CheckboxGroup>
                </div>
              </div>
            </div>
            <div v-for="(item,index) in msg.evaluateList" :key='index'>
