    ...
    <div class="wapper">
      <div class="flex-between header">
        <div class="con bk inp flex-center-start">
          ...
          <p>
            <span>所属项目:</span>&nbsp;
            <Select style="width:8rem;" v-model="querys.categoryId">
      ...
      <div
        style="padding: 0 5px;background: #ffffff;box-shadow: 0 3px 4px 0 rgba(188, 188, 188, 0.21);border-radius: 12px;"
      >
